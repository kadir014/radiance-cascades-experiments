...
from src.common import WINDOW_WIDTH, WINDOW_HEIGHT
...
if __name__ == "__main__":
    ...
    while is_running:
        ...
        _, engine.stage = imgui.slider_int("Rendering stage", engine.stage, 1, 4, format="%d")
